...
The course materials were provided together in `course_files_export.zip`.
...
`course_files_export.zip` >> `Computation` >> `QMnotes1.pdf`

**[2] S. Chiang, Teensy STM11A controller source code**

`course_files_export.zip` >> `Experiments` >> `STM Project` >>
