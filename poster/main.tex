...
project. Her instruction in STM operation, electronics, instrumentation, and
experimental technique gave us the practical foundation needed to construct
and test the microscope. We are especially grateful for the
spring-suspension platform, controller software, course materials, and
constant insight she provided throughout the work.

We also thank Professor Richard Scalettar for teaching the computational and
computer-science foundations that supported this project. His instruction
helped us connect physical measurements with programming, numerical methods,
data analysis, and scientific interpretation. His careful explanations and
intellectual guidance strengthened both our understanding of the underlying
physics and our approach to processing the STM's output.

Finally, we thank Teaching Intern Gibson Meeker. Although his official role
was, as we sometimes joked, to ``babysit us,'' his constant advice, practical
assistance, patience, and good humor made every stage of the project smoother
and far more enjoyable. His willingness to help whenever a problem arose was
an invaluable part of our experience.
