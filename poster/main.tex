...
%
% Page 8 holds the planned Python data-conversion workflow. Keep every item
% visibly marked as a placeholder until the software and experimental data
% actually exist. Pages 6, 9, 10, and 11 remain intentionally blank.
%
